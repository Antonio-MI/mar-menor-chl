...
**`Dockerfile`**
 The base image is Ubuntu 22.04. On top of it, several libraries are installed, along with Python 3.8.5 (used for all developments) and SNAP 11.0.0. Then, the requirements are installed, and all scripts, configuration files, and trained models are copied into the image.
